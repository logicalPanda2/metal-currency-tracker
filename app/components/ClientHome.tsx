...
export default function ClientHome({
	...
	const metal =
		data.metalData.metal.split("")[0].toUpperCase() +
		data.metalData.metal.toLowerCase().slice(1); // capitalize the first letter, concatenate subsequent lowercase characters
		...
		<>
			<header className="p-8">
				<h1 className="text-4xl">
					Gold Price and Currency Exchange Rates
				</h1>
			</header>
			<main className="px-8 flex flex-nowrap gap-x-24 flex-col md:flex-row">
				...
				<section className="pb-8">
					...
					<div className="flex flex-wrap flex-row gap-2 md:gap-4 mb-4">
						<Card
							accentedMainText={troyOuncePrice}
							mainText={currency}
							subText="/ oz t"
						/>
						<Card
							accentedMainText={sellPrice}
							mainText={currency}
							subText="Sell price"
						/>
						<Card
							accentedMainText={buyPrice}
							mainText={currency}
							subText="Buy price"
						/>
						<Card
							accentedMainText={gramPrice}
							mainText={currency}
							subText="/ gram"
						/>
					</div>
					<div className="flex flex-wrap flex-row gap-2 md:gap-4 mb-4">
						<Card
							accentedMainText={targetTroyOuncePrice}
							mainText={targetCurrency}
							subText="Translated / oz t"
						/>
						<Card
							accentedMainText={targetSellPrice}
							mainText={targetCurrency}
							subText="Translated sell price"
						/>
						<Card
							accentedMainText={targetBuyPrice}
							mainText={targetCurrency}
							subText="Translated buy price"
						/>
						<Card
							accentedMainText={targetGramPrice}
							mainText={targetCurrency}
							subText="Translated / gram"
						/>
					</div>
